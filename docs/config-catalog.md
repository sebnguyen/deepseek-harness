...
- `@deepseek-ai/dsh-claim` — requires `agents` · `sessionProjections` ([`packages/claim/claim/src/index.ts`](../packages/claim/claim/src/index.ts))
