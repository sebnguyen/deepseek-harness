...
| [core-prompt-guidance.md](core-prompt-guidance.md) | first-party core personality and core rules (including folded batching/discovery), section order, `Advice:` tool lines, and config |
