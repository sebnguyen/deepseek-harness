...
| [`tool-claim`](tool-claim/README.md) | Model tools `declare_claim` and `abandon_claim`, plus the standing declaration demand | registers on `ctx.tools` and `ctx.systemPrompt` |
