...
export const zh = {
  ...
  'tab.context': '上下文',
  'tab.wire': '请求体',
  'wire.heading': '实际发送的请求体',
  'wire.attempt': '实际发送的请求体（第 {index} 次）',
  'wire.notCaptured': '（本次请求未记录请求体）',
  'wire.provider': '提供方',
  'wire.model': '模型',
  'wire.purpose': '用途',
  'wire.purpose.conversation': '对话',
  'wire.representation': '图片表示',
  'wire.representation.none': '无',
  'wire.representation.file': '文件引用',
  'wire.representation.base64': '内联 base64',
  'context.role.system': '系统',
  'context.role.user': '用户',
  'context.role.assistant': '助手',
  'context.role.tool': '工具',
  'context.role.tools': '工具定义',
  'context.cache.hit': '缓存命中',
  'context.cache.miss': '缓存未命中',
  'context.cache.partial': '部分命中',
  'context.cache.unknown': '缓存状态未知',
  'context.usage': '{used} / {capacity} tokens',
  'context.cacheHitPercent': '缓存命中 {percent}%',
  'context.cacheUnknown': '该请求的缓存统计不完整，因此无法判断命中/未命中。',
  'context.empty': '（无文本预览 — 图片、文件或空内容）',
  'context.notLoaded': '（尚未加载到本视图）',
  'context.loading': '正在加载历史事件以重建上下文…',
  'context.unavailable': '无法从已加载的事件重建该请求的上下文。',
...
export const en: Record<TrajectoryKey, string> = {
  ...
  'tab.usage': 'Usage',
  'tab.context': 'Context',
  'tab.wire': 'Request body',
  'wire.heading': 'Exact request body sent',
  'wire.attempt': 'Exact request body sent (attempt {index})',
  'wire.notCaptured': '(no request body captured for this request)',
  'wire.provider': 'Provider',
  'wire.model': 'Model',
  'wire.purpose': 'Purpose',
  'wire.purpose.conversation': 'Conversation',
  'wire.representation': 'Image representation',
  'wire.representation.none': 'None',
  'wire.representation.file': 'File reference',
  'wire.representation.base64': 'Inline base64',
  'context.role.system': 'System',
  'context.role.user': 'User',
  'context.role.assistant': 'Assistant',
  'context.role.tool': 'Tool',
  'context.role.tools': 'Tool definitions',
  'context.cache.hit': 'Cache hit',
  'context.cache.miss': 'Cache miss',
  'context.cache.partial': 'Partial hit',
  'context.cache.unknown': 'Cache state unknown',
  'context.usage': '{used} / {capacity} tokens',
  'context.cacheHitPercent': '{percent}% cache hit',
  'context.cacheUnknown': "This request's cache accounting is incomplete, so hit/miss can't be determined.",
  'context.empty': '(no text preview — image, file, or empty content)',
  'context.notLoaded': '(not loaded in this view)',
  'context.loading': 'Loading history to reconstruct context…',
  'context.unavailable': 'Could not reconstruct this request’s context from loaded events.',
